...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Step</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.ops4j.coro.model.score.ScorePackage#getStep()
 * @model
 * @generated
 */
public enum Step implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Step</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Step[] VALUES_ARRAY =
		new Step[] {
			C,
			D,
			E,
	...
	/**
	 * A public read-only list of all the '<em><b>Step</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Step> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Step</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Step get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Step result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Step</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Step getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Step result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Step</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static Step get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Step(int value, String name, String literal) {
		this.value = value;
		this.name = name;
